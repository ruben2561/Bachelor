...
def generate_image_with_jpeg_pixelation(jpeg, pixelation, text):
    ...
    # Save the pixelated image
    pixelated.save("images_words_model_training/" + text + "__jpeg" + str(jpeg) + "__pix" + str(pixelation) + ".jpg", format='JPEG', quality=jpeg)
